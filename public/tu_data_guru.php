...
<head>
    ...
    <title>Data Guru - Yayasan Megatama</title>
    ...
    <script src="js/tu_data_guru.js"></script>
...
<body class="font-poppins mode-2">
    ...
    <div id="main-content" class="main-content">
        ...
        <header class="bg-white shadow-sm border-b border-gray-200">
            <div class="px-5 py-2 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="ml-3 text-lg font-semibold text-gray-800">Data Guru</h1>
                </div>
                <div class="flex items-center">
                    <div class="flex items-center">
        ...
        <div class="p-6">
            <div class="bg-white rounded-lg shadow-lg border border-gray-200">
                <!-- Table Header -->
                <div class="p-6 py-4 border-b border-gray-200">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <button onclick="openAddModal()"
                                class="bg-green-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-green-700 transition-colors flex items-center text-sm">
                ...
                <div class="px-6 py-4 border-t border-gray-200">
                    <div class="flex justify-between items-center">
                        <p class="text-sm text-gray-600" id="paginationInfo">Menampilkan 1-9 dari 24 guru</p>
                        <div class="flex items-center space-x-2">
                            <button onclick="previousPage()" class="p-2 text-gray-400 hover:text-gray-600">
                                <i class="fas fa-chevron-left"></i>
                            </button>
                            <div id="pageNumbers" class="flex space-x-1">
                                <!-- Page numbers will be inserted here -->
                            </div>
                            <button onclick="nextPage()" class="p-2 text-gray-400 hover:text-gray-600">
    ...
    <!-- Add/Edit Modal -->
    <div id="teacherModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto hidden">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-xl max-w-md w-full p-6">
                <div class="flex justify-between items-center mb-6">
                    <h3 id="modalTitle" class="text-lg font-semibold text-gray-800">Tambah Data Guru</h3>
                ...
                <form id="teacherForm">
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">NIP/UID</label>
                        ...
                        <!-- <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Nomor HP <span class="text-gray-400 text-xs">(opsional)</span></label>
                                <input type="text" id="teacherPhone" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div> -->
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Upload Foto Wajah <span
                                    class="text-gray-400 text-xs">(opsional)</span></label>
                            <input type="file" accept="image/png, image/jpeg" id="teacherPhoto"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-xl max-w-sm w-full p-6">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Hapus Data Guru</h3>
                    <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menghapus data guru ini? Tindakan ini tidak
                        dapat dibatalkan.</p>
