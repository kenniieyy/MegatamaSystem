...
<head>
    ...
    <title>Data Ruangan - Yayasan Megatama</title>
    ...
    <script src="js/tu_data_ruangan.js"></script>
...
<body class="font-poppins mode-2">
        ...
        <header class="bg-white shadow-sm border-b border-gray-200">
            <div class="px-5 py-2 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="ml-3 text-lg font-semibold text-gray-800">Data Ruangan</h1>
                </div>
                <div class="flex items-center">
                    <div class="flex items-center">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="px-6 py-4 flex items-center justify-between border-t border-gray-200">
                    <div class="text-sm text-gray-500">
                        Menampilkan <span id="currentRange">1-9</span> dari <span id="totalData">12</span> ruangan
                    </div>
    ...
    <!-- Add/Edit Modal -->
    <div id="tambahRuanganModal" class="fixed inset-0 z-50 hidden">
        <div class="fixed inset-0 bg-black bg-opacity-50 modal-backdrop"></div>
        <div class="fixed inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-lg shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <h3 id="modalTitle" class="text-lg font-semibold text-gray-900">Tambah Ruangan Baru</h3>
                    ...
                    <form id="tambahRuanganForm" class="space-y-4">
                        ...
                        <div class="flex space-x-3 pt-4">
                            <button type="button" id="cancelTambahRuangan"
    ...
    <div id="deleteRuangan" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-xl max-w-sm w-full p-6">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Hapus Data Ruangan</h3>
                    <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menghapus ruangan ini? Tindakan ini tidak
                        dapat dibatalkan.</p>
