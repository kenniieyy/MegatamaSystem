...
<head>
    ...
    <title>Data Siswa - Yayasan Megatama</title>
    ...
    <script src="js/tu_data_siswa.js" defer></script>
...
<body class="font-poppins mode-2">
        ...
        <header class="bg-white shadow-sm border-b border-gray-200">
            <div class="px-5 py-2 flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <h1 class="ml-3 text-lg font-semibold text-gray-800">Data Siswa</h1>
                </div>
                <div class="flex items-center">
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 text-sm font-medium text-gray-700">Admin TU</span>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="bg-white rounded-lg shadow-lg border border-gray-200">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                        ...
                        <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                            ...
                            <!-- Action Buttons Naikkan Kelas -->
                            <!-- <button id="naikkanKelasBtn" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">
                                <i class="fas fa-level-up-alt mr-2"></i>Naikkan Kelas
                            </button> -->
                            <button id="tambahSiswaBtn"
                ...
                <div class="px-6 py-4 flex items-center justify-between border-t border-gray-200">
                    <div class="text-sm text-gray-500">
                        Menampilkan <span id="currentRange">1-9</span> dari <span id="totalData">24</span> siswa
                    </div>
    ...
    <!-- Modal Naikkan Kelas -->
    <!-- <div id="naikkanKelasModal" class="fixed inset-0 z-50 hidden">
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-semibold text-center text-gray-900 mb-2">Konfirmasi Kenaikan Kelas</h3>
                    <p class="text-sm text-gray-600 text-center mb-6">
                        Apakah Anda yakin ingin menaikkan kelas semua siswa yang berstatus aktif? 
                        Siswa kelas 9 dan 12 akan otomatis lulus.
                    </p>
                    <div class="flex space-x-3">
                        <button id="cancelNaikkanKelas" class="flex-1 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
                            Batal
                        </button>
                        <button id="confirmNaikkanKelas" class="flex-1 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
                            Ya, Naikkan
                        </button>
                    </div>
                </div>
    ...
    <!-- Add/Edit Modal -->
    <div id="tambahSiswaModal" class="fixed inset-0 z-50 hidden">
        <div class="fixed inset-0 bg-black bg-opacity-50 modal-backdrop"></div>
        <div class="fixed inset-0 flex items-center justify-center p-4">
                ...
                <div class="p-6">
                    ...
                    <form id="tambahSiswaForm" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="nis" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
                                    <input type="hidden" name="nis_lama" id="nis_lama">
                        ...
                        <div class="flex space-x-3 pt-4">
                            <button type="button" id="cancelTambahSiswa"
    ...
    <div id="deleteSiswa" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-xl max-w-sm w-full p-6">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Hapus Data Siswa</h3>
                    <p class="text-gray-600 mb-6">Apakah Anda yakin ingin menghapus Siswa ini? Tindakan ini tidak
                        dapat dibatalkan.</p>
