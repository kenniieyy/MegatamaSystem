...
<head>
    ...
    <title>Settings Admin TU - Yayasan Megatama Jambi</title>
    ...
    <script src="js/tu_settings.js"></script>
    <style>
        .sidebar-transition {
...
<body class="font-poppins mode-2">
    <!-- Tampilan overlay untuk layar kecil (mobile) -->
    ...
    <div id="sidebar" class="sidebar text-white flex flex-col">
        ...
        <div class="p-3">
            ...
            <nav class="space-y-1">
                ...
                <a href="tu_settings.php" class="menu-item active px-3 py-2 text-sm font-medium rounded-md">
                    <div class="menu-icon">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex flex-col items-center mb-8">
                            ...
                            <div class="text-center">
                                <h4 class="text-lg font-medium text-gray-800">Admin TU <br> <?= $tu['role'] ?></h4>
                                <!-- <p class="text-sm text-gray-500">Admin TU</p> -->
                            </div>
                        </div>
