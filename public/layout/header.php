        ...
        <div class="p-3">
            ...
            <nav class="space-y-1">
                ...
                <a href="riwayat_presensi_guru.php"
                    class="menu-item px-3 py-2 text-sm font-medium text-blue-200 rounded-md <?php echo ($currentPage == 'riwayat_presensi_guru.php') ? 'active' : 'text-blue-200'; ?>">
                    <div class="menu-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-300" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="presensi_siswa.php" class="menu-item px-3 py-2 text-sm font-medium text-blue-200 rounded-md <?php echo ($currentPage == 'presensi_siswa.php') ? 'active' : 'text-blue-200'; ?>">
                    <div class="menu-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-300" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="naik_kelas.php" class="menu-item px-3 py-2 text-sm font-medium text-blue-200 rounded-md <?php echo ($currentPage == 'naik_kelas.php') ? 'active' : 'text-blue-200'; ?>">
                    <div class="menu-icon">
                ...
                <a href="settings_guru.php" class="menu-item px-3 py-2 text-sm font-medium text-blue-200 rounded-md <?php echo ($currentPage == 'settings_guru.php') ? 'active' : 'text-blue-200'; ?>">
                    <div class="menu-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-300" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
