...
function initializeNavigation() {
    ...
    if (nextToAttendance) {
        nextToAttendance.addEventListener('click', function () {
            ...
            const dateInput = document.getElementById('date');
            if (dateInput && checkAttendanceExists(dateInput.value, selectedClass)) {
            ...
            if (dateInput2 && startTimeInput && endTimeInput && attendanceInfoDisplay) {
                const date = new Date(dateInput2.value).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' });
...
// Simpan data presensi (TANPA TOAST NOTIFICATION)
...
// Simpan kehadiran yang telah diedit (DENGAN TOAST NOTIFICATION)
