document.addEventListener('DOMContentLoaded', function () {
    ...
    submitBtn?.addEventListener('click', () => {
        ...
        const payload = {
            ...
            penanggung_jawab: reservationData.get('responsible-teacher') // bisa opsional
        };
                ...
                data.items.forEach(item => {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="px-6 py-3 text-sm">
                            ...
                            <button onclick="deleteReservation(${item.id})" class="text-red-500 mr-2"><i class="fas fa-trash"></i></button>
                            <button onclick="printReservation(${item.id})" class="text-gray-600"><i class="fas fa-print"></i></button>
                        </td>
                    `;
                    historyTableBody.appendChild(row);
                });
    ...
    window.editReservation = function (id) {
        alert(`Edit peminjaman dengan ID: ${id}`);
    }
    ...
    window.printReservation = function (id) {
        window.open(`http://localhost/MegatamaSystem/src/Print/cetak_reservasi.php?id=${id}`, '_blank');
    }
