        ...
        if ($isBulk && !empty($studentsToUpdate)) {
            ...
            foreach ($studentsToUpdate as $student) {
                ...
                if ($newStatus === 'lulus') {
                    ...
                    $update_query = "UPDATE siswa SET status_siswa = 'lulus' WHERE nis = '$sId'";
                } else {
            ...
            if ($studentId && $class) {
                ...
                if ($newStatus === 'lulus') {
                    ...
                    // Update kelas siswa
                    $update_query = "UPDATE siswa SET kelas = '$newClass', status_siswa = 'naik_kelas' WHERE nis = '$studentId'";
                }
